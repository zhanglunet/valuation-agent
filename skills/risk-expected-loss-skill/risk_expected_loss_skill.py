...
def main() -> None:
    ...
    summary = evaluate_risks(risks, assumptions)
    print(json.dumps({
        "status": "ok",
        "total_expected_loss_base": summary["total_expected_loss_base"],
        "total_expected_loss_by_scenario": summary["total_expected_loss_by_scenario"],
        "risks": [r.to_dict() for r in summary["risks"]],
